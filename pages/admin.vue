	...
	<div class="admin-page">
	  ...
	  <form @submit.prevent="addPlayer">
		...
		<div class="form-group">
		  ...
		  <input type="text" v-model="nationalitySearch" placeholder="Search for a country" />
		  <select id="nationality" v-model="player.nationality" v-if="filteredCountries.length > 0">
