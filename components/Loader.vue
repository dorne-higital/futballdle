<template>
	<div class="loader-container">
		<svg 
			class="football" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 463 463" xml:space="preserve">
			<g>
...
<style lang="scss" scoped>
	.loader-container {
		...
		.football {
			...
			background: linear-gradient(135deg, #fff 40%, #555555a8 80%); /* Basic football pattern */
			border-radius: 50%;
			height: 6rem;
			position: relative;
			width: 6rem;
