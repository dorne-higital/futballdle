        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="setting-section delete-section">
                    ...
                    <div class="buttons">
                        <button v-if="!confirmResetVisible" class="button danger" @click="confirmReset">Delete & Reset</button>

                        <p v-if="confirmResetVisible" class="confirmation-message">
                            Are you sure?

                            <span class="group">
                                <button class="button danger" @click="resetAndDelete">Yes, delete</button>

                                <button class="button link" @click="cancelReset">Cancel</button>
                            </span>
                        </p>
                    </div>
                </div>
...
<script setup>
  ...
  const resetAndDelete = async () => {
    ...
    try {
      ...
      if (!docSnap.exists()) {
        console.warn('resetAndDelete: User document does not exist:', props.userId);
        clearGameState();
        location.reload();
        return;
      }
